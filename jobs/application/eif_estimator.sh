...
#SBATCH -o logs/application/aligned_t0/EIF/log_eif.stdout_%a ## STDOUT
#SBATCH -e logs/application/aligned_t0/EIF/log_eif.stderr_%a ## STDERR
...
Rscript scripts/analysis/aligned_t0/fit_EIF_estimator.R $SLURM_ARRAY_TASK_ID