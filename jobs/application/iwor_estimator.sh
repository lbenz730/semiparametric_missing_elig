...
#SBATCH -o logs/application/aligned_t0/IWOR/log_iwor.stdout_%a ## STDOUT
#SBATCH -e logs/application/aligned_t0/IWOR/log_iwor.stderr_%a ## STDERR
...
Rscript scripts/analysis/aligned_t0/fit_iwor_estimator.R $SLURM_ARRAY_TASK_ID